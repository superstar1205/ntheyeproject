          ...
          <Card className="custom-card overflow-hidden">
            <Card.Body>
              <div className="d-flex mb-3">
                <div>
                  <h4 className="main-content-label mb-1"><i className="bi bi-columns">&nbsp;&nbsp;&nbsp;Add College</i></h4>
                </div>
                ...
                <Row className="row-sm">
                    ...
                    <div className="plan-card text-md-right">
                      <h6>College name&nbsp;
                        <OverlayTrigger
                          ...
                          overlay={
                            <Tooltip className="tooltip tooltip-primary1">
                              Enter the name of the new college
                            </Tooltip>
                          }
                        >
                          <i className="bi bi-exclamation-circle"></i>
                  ...
                  <Col xl={8} md={6} lg={6} sm={6}>
                    <div className="plan-card text-right">
                      <Form>
                        <FormGroup className="form-group">
                          <Form.Control type="text" className="form-control" id="firstName" placeholder="Enter college Name *" />
                        </FormGroup>
                      </Form>
                    </div>
                  </Col>
                ...
                <Row className="row-sm">
                  <Col xl={12} md={6} lg={6} sm={6}>
                    <div className="d-flex ms-auto"><Button variant="" type="button" className="btn btn-teal btn-w-sm mb-1">
                      <i className="fa fa-plus"></i> Add New College
                    </Button></div>
                  </Col>
                </Row>
              </div>
